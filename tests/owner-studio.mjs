...
assert.match(studioSource, /VK вернул несовместимый сервер фотографии/);
assert.match(studioSource, /const maxSide = 2560/);
assert.match(studioSource, /candidate.status >= 500/);
assert.match(studioSource, /Сервер фотографии VK недоступен/);
