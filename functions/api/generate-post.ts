...
const publishedExperimentEvidence: Record<string, string[]> = {
  ...
  'kiwi-stratona': [
    'Киви Стратона выращивается в саду автора из семян; это многолетний эксперимент в климате Донбасса.',
    'Растения проходили многолетние зимовки и продолжали развиваться после повреждений.',
    'В 2026 году впервые зафиксированы цветки; по наблюдению автора они мужские.',
    'Плодоношение не подтверждено; женского цветения для завязывания плодов пока нет.',
    'Точный год посева и хронология прошлых зимовок ещё требуют уточнения.',
  ],
};
