...
export const plants: Plant[] = [
  ...
  },
  {
    ...
    description: 'Киви, выращенное из семян. Эксперимент продолжается около 22 лет; в текущем наблюдении появились первые мужские цветки.',
    images: [], yearsInGarden: 22, status: 'эксперимент', experimental: true,
    personalNotes: 'Один из центральных сюжетов сайта — история растения от семени до первого цветения.',
    advantages: ['Уникальная длительная история наблюдений'], disadvantages: ['Плодоношение пока не подтверждено'],
    relatedArticles: ['kivi-stratona-pervoe-cvetenie'], confirmationNeeded: ['Год посева', 'Даты ключевых зимовок', 'Год первого цветения'],
  },
  {
